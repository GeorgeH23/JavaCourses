package kJavaFX.mJavaFXChallengeContactsApp.datamodel;
...
public class ContactData {
    ...
    public void loadContacts() {
        try {
            ...
            File file = new File(getClass().getResource("/kJavaFX/mJavaFXChallengeContactsApp/" + CONTACTS_FILE).toURI());
