...
public class Challenge7 {
    ...
    public static void main(String[] args) {
        BankAccountSecond account1 = new BankAccountSecond("12345-678", 500.00);
        BankAccountSecond account2 = new BankAccountSecond("98765-432", 1000.00);
...
class BankAccountSecond {
    ...
    BankAccountSecond(String accountNumber, double balance) {
    ...
    public boolean transfer(BankAccountSecond destinationAccount, double amount) {
        if (withdraw(amount)) {
...
class Transfer implements Runnable {
    private BankAccountSecond sourceAccount, destinationAccount;
    private double amount;

    Transfer(BankAccountSecond sourceAccount, BankAccountSecond destinationAccount, double amount) {
